...
## Security > WEB Firewall > 제품 소개 > 펜타시큐리티(WAPPLES SA) { #security-web-firewall-product-introduction-penta-security-wapples-sa }
...
## 서비스 구성도 { #service-configuration-diagram }
